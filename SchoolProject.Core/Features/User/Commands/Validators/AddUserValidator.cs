...
namespace SchoolProject.Core.Features.User.Commands.Validators
{
	public class AddUserValidator : AbstractValidator<AddUserCommand>
	{
		...
		#region Constructors
		public AddUserValidator(IStringLocalizer<SharResources> stringLocalizer)
		{
		...
		public void ApplyValidationsRules()
		{
			...
			RuleFor(x => x.ConfirmPassword)
				.Equal(x => x.Password).WithMessage(_stringLocalizer[SharedResourcesKey.passNotEqualConfPass]);
		}
